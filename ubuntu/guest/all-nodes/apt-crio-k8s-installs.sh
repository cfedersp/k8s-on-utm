...
cat $(dirname $0)/crio-prerelease.key | gpg --dearmor -o /etc/apt/keyrings/cri-o-apt-keyring.gpg
cat $(dirname $0)/kubernetes-release.key | gpg --dearmor -o /etc/apt/keyrings/kubernetes-apt-keyring.gpg
